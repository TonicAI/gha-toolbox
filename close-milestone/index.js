...
async function run() {
    ...
    const releaseNumberText = github.context.ref ? github.context.ref.substr(11, github.context.ref.length - 1) : github.payload.release.name.substr(1, github.payload.release.name - 1);
